...
export default function CreateProductAdminPage() {
  ...
  async function handleSubmit() {
    ...
    if (images.length === 0) {
      toast({ title: "Imagem obrigatória", description: "Envie ao menos uma imagem do produto.", variant: "destructive" })
      return
    }
  ...
  return (
    <div className="flex flex-col gap-4 sm:gap-6 w-full">
      <div className="flex items-center gap-4">
        ...
        <h1 className="text-xl font-bold text-foreground">Cadastrar item</h1>
      </div>
      ...
      <section className="rounded-xl border border-border bg-card p-4 sm:p-6 lg:p-8 shadow-sm">
        ...
        <div className="flex flex-col gap-6">
          ...
          <p className="text-xs text-muted-foreground">
            Envie uma ou mais imagens. Depois escolha qual delas será a imagem principal do item.
          </p>
